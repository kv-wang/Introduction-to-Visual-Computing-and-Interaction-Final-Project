...
namespace VCX::Labs::Rendering {
    ...
    float Disney(float const & roughness, glm::vec3 const & w, glm::vec3 const & h);
    ...
    glm::vec3 Sample(VCX::Engine::Light const & light);
    ...
    struct BVHNode {
        ...
        BVHNode * right = NULL;
        int       n = 0, index = -1; 
        glm::vec3 AA = glm::vec3(0.0f), BB = glm::vec3(0.0f); 
    };
